...
NTOPICS = 40
DTPD_FILE = "DT_PD/dt_pd_ntop"+str(NTOPICS)+"_2.json"
TWPD_FILE = "WT_PD/wt_pd_ntop"+str(NTOPICS)+"_2.json"
...
#for key in data.keys():
    ...
    reranked_dictionary = reranked_dictionary
    ...
    for word in text:
        if word in reranked_dictionary:
            print word, reranked_dictionary.index(word)
            cnt+=1
    #print key, len(text), float(cnt)/len(text)
    print text
    #print reranked_dictionary[:100]
